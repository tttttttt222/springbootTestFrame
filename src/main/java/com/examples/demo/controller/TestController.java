...
public class TestController {
	...
	@RequestMapping("/chain/{commandId}")
	public String doCommand(@PathVariable int commandId) throws Exception {
		BaseChain bean = SpringBeanUtil.getBean("testCommand" + commandId, BaseChain.class);
		Map map = new HashMap();
		map.put("context", "doExecute: " + commandId);
		bean.execute(map);
		return "success";
	}
